...
<div class="acount">
    <div class="profile">
        <img class="profile-img" src="<?php echo htmlspecialchars($view_user['image_path']); ?>" alt="">
    ...
    <div class="nickname"><?php echo htmlspecialchars($view_user['nickname']); ?></div>
    <div class="name"><?php echo htmlspecialchars($view_user['name']); ?></div>
    <div class="follow">
    ...
    <div class="text"><?php echo htmlspecialchars($view_user['profile']); ?></div>
</div>